...
class GridViewSample extends StatelessWidget {
  ...
  GridViewSample({Key? key, required this.title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    List<Container> _buildGridTileList(int count) => List.generate(
        count,
        (index) => Container(
              child: Image.asset("assets/images/pic${index + 1}.jpg"),
            ));
    ...
    Widget _buildGridItem(BuildContext context, int index) => Container(
          child: Image.asset("assets/images/pic${index + 1}.jpg"),
        );
